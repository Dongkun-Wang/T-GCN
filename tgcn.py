...
class TGCN_Cell(tf.compat.v1.nn.rnn_cell.RNNCell):
    """Temporal Graph Convolutional Network """

    def __init__(self, num_units, adj, num_nodes, act=tf.nn.tanh, reuse=None):
    ...
    def _gc(self, inputs, state, output_size, bias=0.0, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            weights = tf.get_variable(
                'weights', [input_size, output_size], initializer=tf.compat.v1.keras.initializers.glorot_normal)
